...
const TLSComponent = ({ onClose }) => {
    const description = {
        name: "TLS",
        fullName: "Transport Layer Security",
        description: "A cryptographic protocol providing encryption, authentication, and data integrity for network communications.",

        packetStructure: {
            recordProtocol: "Organizes data into records with type and length",
            handshakeProtocol: "Establishes secure connection and negotiates parameters",
            alertProtocol: "Communicates warnings and errors",
            changeSpec: "Signals switch to negotiated cipher",
            applicationData: "Encrypted payload record"
        },

        compareWith: {
            SSL: "SSL is the deprecated predecessor; TLS is the modern standard",
            HTTPS: "HTTPS is HTTP secured with TLS",
            IPSec: "IPSec provides network layer security; TLS is transport layer",
            VPN: "VPN tunnels all traffic; TLS secures specific applications",
            WireGuard: "Both provide encryption; WireGuard is simpler VPN protocol"
        }
    };
